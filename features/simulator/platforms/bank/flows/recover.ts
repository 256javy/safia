    ...
    screens: [
      {
        ...
        next: (data, ctx) => {
          ...
          useAccountsStore.getState().pushInbox(ctx.account.id, {
            kind: "email",
            subject: "SecureBank: recupera tu cuenta",
            code,
            body: `Tu código de recuperación de SecureBank es ${code}. Caduca en 10 minutos. Si no solicitaste este cambio, ignora este mensaje.`,
          });
          return "code";
        },
